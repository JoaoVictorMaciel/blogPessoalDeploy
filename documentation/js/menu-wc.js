                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-ba20f4c5c18914696ca13eef66b0cd7a"' : 'data-target="#xs-components-links-module-AppModule-ba20f4c5c18914696ca13eef66b0cd7a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-ba20f4c5c18914696ca13eef66b0cd7a"' :
                                            'id="xs-components-links-module-AppModule-ba20f4c5c18914696ca13eef66b0cd7a"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/EditPostagemComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >EditPostagemComponent</a>
                                            </li>
                                            <li class="link">
